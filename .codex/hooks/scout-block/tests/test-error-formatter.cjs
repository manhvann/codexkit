...
test('formatConfigPath with codexDir', formatConfigPath('/home/user/.codex').includes('.ckignore'));
test('formatConfigPath without codexDir', formatConfigPath(null) === '.codex/.ckignore');
test('formatConfigPath empty string', formatConfigPath('') === '.codex/.ckignore');
...
const blockError = formatBlockedError({
  ...
  tool: 'Bash',
  codexDir: '/home/user/project/.codex'
});
