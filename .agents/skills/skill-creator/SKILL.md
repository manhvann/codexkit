...
1. Understand with concrete examples (ask the user)
...
## References
- [Agent Skills Docs](https://github.com/openai/codexen/docs/codex-code/skills.md)
- [Best Practices](https://github.com/openai/codexen/docs/agents-and-tools/agent-skills/best-practices.md)
