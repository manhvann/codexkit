...
Full JSON schema for `.codex-plugin/marketplace.json`.
...
`codex-code-marketplace`, `codex-code-plugins`, `codex-plugins-official`, `openai-marketplace`, `openai-plugins`, `agent-skills`, `life-sciences`. Names impersonating official marketplaces also blocked.
