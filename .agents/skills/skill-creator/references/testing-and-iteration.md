...
- **Manual testing** — Run queries in Codex, observe behavior. Fast iteration.
- **Scripted testing** — Automate test cases in Codex for repeatable validation.
- **Programmatic testing** — Build eval suites via skills API for systematic testing.

**Pro tip:** Iterate on a single challenging task until Codex succeeds, then extract the winning approach into the skill. Expand to multiple test cases after.
...
**Debug:** Ask Codex: "When would you use the [skill-name] skill?" — it quotes the description back.
