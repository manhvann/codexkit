...
2. `$HOME/.codex/skills/<skill-name>/.env` (skill-specific)
3. `$HOME/.codex/skills/.env` (shared skills)
4. `$HOME/.codex/.env` (global)
5. `./.agents/skills/${SKILL}/.env` (cwd)
6. `./.agents/skills/.env` (cwd)
7. `./.codex/.env` (cwd)
...
load_dotenv('$HOME/.codex/.env')
load_dotenv('$HOME/.codex/skills/.env')
load_dotenv('$HOME/.codex/skills/my-skill/.env')
load_dotenv('./.agents/skills/my-skill/.env')
load_dotenv('./.agents/skills/.env')
load_dotenv('./.codex/.env')
