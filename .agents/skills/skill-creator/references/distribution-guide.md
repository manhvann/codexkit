...
2. Zip the folder
3. Upload to Codex: Settings > Capabilities > Skills
...
|---|---|
| End users interacting directly | Codex / Codex |
| Manual testing during development | Codex / Codex |
...
2. Install: Codex > Settings > Skills > Upload skill (zipped)
