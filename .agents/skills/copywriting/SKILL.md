...
```bash
python .agents/skills/copywriting/scripts/extract-writing-styles.py --list        # List files
python .agents/skills/copywriting/scripts/extract-writing-styles.py --style <name> # Extract style
```
...
**Primary:** fullstack_developer | **Related:** brand-guidelines, content-marketing, email-marketing
