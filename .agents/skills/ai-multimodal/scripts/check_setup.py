...
def check_centralized_resolver():
    ...
    resolver_path = codex_root / 'scripts' / 'resolve_env.py'
...
def find_api_key():
    ...
    try:
        ...
        if api_key:
            ...
            print_info("python ~/.codex/scripts/resolve_env.py GEMINI_API_KEY --skill ai-multimodal --verbose")
...
def provide_setup_instructions():
    ...
    print(f"   $ echo 'GEMINI_API_KEY=your-api-key-here' >> ~/.codex/.env")
    ...
    print("\n4. Debug if needed:")
    print(f"   $ python ~/.codex/scripts/resolve_env.py --show-hierarchy --skill ai-multimodal")
    print(f"   $ python ~/.codex/scripts/resolve_env.py GEMINI_API_KEY --skill ai-multimodal --verbose")
