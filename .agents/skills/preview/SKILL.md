...
If invoked without arguments, ask the user to choose available preview operations:
...
Present options with header "Preview Operation", question "What would you like to do?".
