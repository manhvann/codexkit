#!/usr/bin/env python3
"""
CodexKit Help - All-in-one guide with dynamic skill discovery.
Scans .agents/skills/ directory to build catalog at runtime.
...
CATEGORY_GUIDES = {
    ...
    "config": {
        "title": "CodexKit Configuration (.ck.json)",
        "workflow": [
            ("Global", "Set user prefs in `~/.codex/.ck.json`"),
            ("Local", "Override per-project in `./.codex/.ck.json`"),
    ...
    "notifications": {
        ...
        "workflow": [
            ...
            ("2. Add hook", "Add Stop hook to `.codex/hooks.json` (see below)"),
...
def discover_skills(skills_dir: Path) -> dict:
    """Scan .agents/skills/ and build skill catalog from SKILL.md files."""
    skills = {}
    categories = {}
...
def show_config_guide() -> None:
    ...
    print("# CodexKit Configuration (.ck.json)")
    print()
    print("**Locations (cascading resolution):**")
    print("- Global: `~/.codex/.ck.json` (user preferences)")
    print("- Local: `./.codex/.ck.json` (project overrides)")
    print()
    ...
    print("## Quick Start")
    print()
    print("**Global config** (`~/.codex/.ck.json`) - your preferences:")
    print("```json")
    print('{')
    print('  "locale": {')
    ...
    print("```")
    print()
    print("**Local override** (`./.codex/.ck.json`) - project-specific:")
    print("```json")
    print('{')
    ...
    print("```bash")
    print("# ~/.codex/.ck.json - applies everywhere")
    ...
    print("# Local (.codex/.ck.json): issuePrefix = \"JIRA-\"")
...
def show_coding_level_guide() -> None:
    ...
    print("# Coding Level (Adaptive Communication)")
    print()
    print("Adjusts Codex's communication style based on user's experience level.")
    ...
    print("- Global: `~/.codex/.ck.json` - personal preference")
    print("- Local: `./.codex/.ck.json` - project override")
    print()
    print("---")
    print()
    print("## How It Works")
...
def main():
    # Find .agents/skills directory
    script_path = Path(__file__).resolve()
    # .agents/skills/ck-help/scripts/ck-help.py -> .agents/skills
