...
Per-session override: `codex --teammate-mode in-process`
...
Codex decides teammate count based on task, or you specify:
...
Removes shared team resources (`~/.codex/teams/` and `~/.codex/tasks/` entries).
