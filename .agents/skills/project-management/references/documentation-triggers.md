...
MUST update project documentation in the configured `Docs:` path when:
...
Use `docs_manager` subagent for documentation updates:

```
Task(
  agent type: "docs_manager",
  prompt: "Update ./docs for [changes]. Work context: [path]",
  description: "Update docs"
)
```

Project manager coordinates WHEN to update; docs_manager handles HOW.
