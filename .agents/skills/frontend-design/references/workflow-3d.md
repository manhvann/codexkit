...
python3 .agents/skills/ui-ux-pro-max/scripts/search.py "immersive 3d" --domain style
python3 .agents/skills/ui-ux-pro-max/scripts/search.py "animation" --domain ux
```

## Workflow Steps

### 1. Create Implementation Plan
Use `ui_ux_designer` + `researcher` subagents:
...
Use `ui_ux_designer` subagent to build:
